...
int main() {
  std::string image_path1 =
      "/home/jetson/Software/ViOdFeatExt/LogData/"
  ...
  std::cout << "Time for first image ORB: " << one_img_time << " seconds."
            << std::endl;
  std::cout << "Time for second image ORB: " << two_img_time << " seconds."
            << std::endl;
  std::cout << "Time for matching descriptors: " << matcher_time << " seconds."
            << std::endl;
